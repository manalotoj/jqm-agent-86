...
ENV_MODE="${AGENT86_ENV_MODE:-local}"

COMMON_ENV_FILE="${BACKEND_ROOT}/.env.common"
API_ENV_FILE="${BACKEND_ROOT}/.env.api"
MODE_ENV_FILE="${BACKEND_ROOT}/.env.${ENV_MODE}"
...
describe_env_files "API" "${COMMON_ENV_FILE}" "${API_ENV_FILE}" "${MODE_ENV_FILE}"
echo "Starting API on http://${API_HOST}:${API_PORT}"
(
  load_env_files "${COMMON_ENV_FILE}" "${API_ENV_FILE}" "${MODE_ENV_FILE}"
