...
bash "$REPO_ROOT/common/scripts/azure_container_apps/create_container_registry.sh" \
...
bash "$REPO_ROOT/common/scripts/azure_container_apps/create_container_apps_environment.sh" \
  --resource-group "$RESOURCE_GROUP" \
  --location "$LOCATION" \
...
bash "$REPO_ROOT/common/scripts/azure_static_web_apps/create_static_web_app.sh" \
  --resource-group "$RESOURCE_GROUP" \
  --location "$LOCATION" \
