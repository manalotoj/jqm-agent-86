...
ARTIFACT_PROCESSING_CONTAINER_NAME="artifact-processing"
ARTIFACT_ANALYSIS_JOBS_CONTAINER_NAME="artifact-analysis-jobs"
SHOW_SECRETS=false
...
ensure_container "$ACCOUNT_NAME" "$DATABASE_NAME" "$ARTIFACT_PROCESSING_CONTAINER_NAME" "/session_id"
ensure_container "$ACCOUNT_NAME" "$DATABASE_NAME" "$ARTIFACT_ANALYSIS_JOBS_CONTAINER_NAME" "/session_id"
...
echo "    COSMOS_ARTIFACT_PROCESSING_CONTAINER_NAME=$ARTIFACT_PROCESSING_CONTAINER_NAME"
echo "    COSMOS_ARTIFACT_ANALYSIS_JOBS_CONTAINER_NAME=$ARTIFACT_ANALYSIS_JOBS_CONTAINER_NAME"