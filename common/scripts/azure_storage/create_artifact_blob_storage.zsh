...
To print the resulting env values later without exposing the real account key,
use:
  /Users/johnmanaloto/source/github/jqm-agent-86/common/scripts/azure_storage/print_artifact_blob_env.zsh \
    --resource-group <name> \
